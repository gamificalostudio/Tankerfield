...
bool M_Render::Awake(pugi::xml_node& config)
{
	...
	else
	{
		...
		fPoint tank_1_pos_screen = app->map->MapToScreenF(app->scene->tanks[0]->pos_map);
		...
		fPoint tank_2_pos_screen = app->map->MapToScreenF(app->scene->tanks[1]->pos_map);
		...
		fPoint tank_3_pos_screen = app->map->MapToScreenF(app->scene->tanks[2]->pos_map);
		...
		fPoint tank_4_pos_screen = app->map->MapToScreenF(app->scene->tanks[3]->pos_map);
