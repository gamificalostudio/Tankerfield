...
public:
	...
	bool BlitParticle(SDL_Texture* texture, int x, int y, Camera * current_camera, const SDL_Rect* section = NULL, const SDL_Rect* rectSize = NULL, const SDL_Color & color = { 0u, 0u, 0u, 0u }, const SDL_BlendMode & blend_mode = SDL_BLENDMODE_NONE, float speed = 1.0f, double angle = 0) const;
