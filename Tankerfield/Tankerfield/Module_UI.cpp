...
// const getter for atlas
 SDL_Texture* ModuleUI::GetAtlas() const 
{
	return atlas;
}

 ClickState ModuleUI::GetClickState() const
 {
	 return click_state;
 }
...
// Creation methods =================================================================
 ...
 UI_Object * ModuleUI::CreateObject(const fPoint position, UI_Object_Definition definition, Gui_Listener * listener)
 {
 ...
 Label* ModuleUI::CreateLabel(const fPoint position, const String text,  Label_Definition definition, Gui_Listener* listener)
{
...
Image* ModuleUI::CreateImage(const fPoint position, Image_Definition definition , Gui_Listener* listener)
{
...
Button* ModuleUI::CreateButton(const fPoint position, Button_Definition definition, Gui_Listener* listener)
{
...
Slider * ModuleUI::CreateSlider(const fPoint position, Slider_Definition definition, Gui_Listener * listener)
{
...
Checkbox * ModuleUI::CreateCheckbox(const fPoint position, Checkbox_Definition definition, Gui_Listener * listener)
{
...
TextPanel * ModuleUI::CreateTextPanel(const fPoint position, TextPanel_Definition definition, Gui_Listener * listener)
{
...
UI_Object * ModuleUI::GetClickedObject()
{
	return selected_object;
}

UI_Object * ModuleUI::GetScreen()
{
	return main_object;
}

bool ModuleUI::DeleteObject(UI_Object * object)
{
...
void ModuleUI::SetStateToBranch(const ObjectState state, UI_Object * branch_root)
{
...
fPoint ModuleUI::GetMouseOffset() const
{
	return mouse_offset;
}

void ModuleUI::SetCursorOffset(const fPoint offset)
{
	mouse_offset = offset;

}

bool ModuleUI::SelectClickedObject()
{
...
void ModuleUI::DrawUI(UI_Object * object)
{
	if (object == nullptr)
	{
		return;
...
void ModuleUI::UpdateGuiPositions(UI_Object * object, fPoint cumulated_position)
{
	if (object == nullptr)
	{
		return;
